    ...
    return (
        <div className="flex w-full items-center justify-between lg:hidden">
               ...
               <div classname="flex items-center gap-3">
                   ...
                   {
                      isDropDownOpen && (
                       <div className="absolute shadow-lg py-3 -bottom-20 -right-4 bg-white z-20 flex flex-col gap-2">
          ...
          <div className="hidden gap-4 w-full items-center justify-between lg:flex ">
               ...
               <div className="w-3/4 bg-white shadow-md p-3 flex items-center gap-3 border border-gray-200 rounded">
                  <div className="flex items-center gap-2 border-r-2 border-gray-300 pr-2">
                     ...
                     <input type="text" placeholder="Visakhapatnam" className="focus:outline-none"/>
                        <IoMdArrowDropdown/>
                  </div>
