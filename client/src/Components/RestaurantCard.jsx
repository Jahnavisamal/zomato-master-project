               ...
               <div className="w-full h-56 lg:h-64 relative">
                   <div className="absolute w-full bottom-4 flex items-end justify-between">
                       <div className="flex flex-col gap-2 items-start">
                           {props.isPro && (
                               <span className="bg-zomato-400 text-white px-2 py-1 text-sm rounded">Pro extra 15% OFF</span>
                           )}
                           {props.isOff && (
                   ...
                   <img
                     // src={props.photos.lenght && props.photos[0]}
                      src={image.images.lenght && image.images[0].location}
                      alt="food"
